...
import com.saddss.shortlink.project.dao.entity.LinkAccessStatsDO;
import com.saddss.shortlink.project.dto.req.ShortLinkGroupStatsAccessRecordReqDTO;
import com.saddss.shortlink.project.dto.req.ShortLinkGroupStatsReqDTO;
...
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {
    ...
    @Select("<script> " +
            ...
            "    tlal.user, " +
            "    CASE " +
            "        WHEN MIN(tlal.create_time) BETWEEN CONCAT(#{startDate}, ' 00:00:00') AND CONCAT(#{endDate}, ' 00:00:00') THEN '新访客' " +
            "        ELSE '老访客' " +
            "    END AS uvType " +
            "FROM " +
            "    t_link tl INNER JOIN " +
    ...
    @Select("<script> " +
            ...
            "    tlal.user, " +
            "    CASE " +
            "        WHEN MIN(tlal.create_time) BETWEEN CONCAT(#{startDate}, ' 00:00:00') AND CONCAT(#{endDate}, ' 00:00:00'), ' 23:59:59') THEN '新访客' " +
            "        ELSE '老访客' " +
            "    END AS uvType " +
            "FROM " +
            "    t_link tl INNER JOIN " +
